...
public class BudgetsParentWheelAdapter extends AbstractWheelTextAdapter {
    private ArrayList<Budget> budgets;

    public BudgetsParentWheelAdapter(Context context, ArrayList<Budget> budgets) {
    ...
    public View getItem(int index, View cachedView, ViewGroup parent) {
        ...
        budgetTextView.setText(budgets.get(index).getParentName());
